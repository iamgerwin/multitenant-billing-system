...
import type { InvoiceUpdatePayload, ApiErrorResponse } from '@billing/shared'
...
<template>
  <div class="max-w-4xl mx-auto">
    <UiHeader
      ...
      :back-link="`/invoices/${invoiceId}`"
      back-label="Back to Invoice"
    />

    <!-- Loading -->
    <UiSpinner v-if="isLoading" message="Loading invoice..." />
    ...
    <form v-else @submit.prevent="handleSubmit" class="space-y-8">
      ...
      <!-- Actions -->
      <FormActions
        :cancel-link="`/invoices/${invoiceId}`"

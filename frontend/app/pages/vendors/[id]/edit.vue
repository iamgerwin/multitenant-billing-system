...
<template>
  <div class="max-w-4xl mx-auto">
    <UiHeader
      title="Edit Vendor"
      description="Update the vendor details below"
      :back-link="`/vendors/${vendorId}`"
      back-label="Back to Vendor"
    />

    <!-- Loading -->
    <UiSpinner v-if="isLoading" message="Loading vendor..." />
